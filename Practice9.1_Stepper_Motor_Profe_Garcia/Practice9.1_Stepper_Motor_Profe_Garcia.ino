/* Motor Paso a Paso ajustado a grados
 ...
 Tienda online: http://dinastiatecnologica.com/
...
int retardo = 5;        // Tiempo de retardo en ms (celocidad del motor)
...
void loop() {
  while (Serial.available()) {   // Leer el valor enviado por el puerto serial
    ...
    leeCadena += c;              // Convierte xaracteres a cadena de caracteres
  }
  ...
  leeCadena = ""; // Inicializar la cadena de caracteres recibidos
